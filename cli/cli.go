...
import (
	...
	"github.com/clprt333/test-golang-blockchain/blockchain"
	"github.com/clprt333/test-golang-blockchain/network"
	"github.com/clprt333/test-golang-blockchain/wallet"
)
...
func (cli *CommandLine) printUsage() {
	...
	fmt.Println(" createblockchain -address ADDRESS creates a blockchain and sends genesis reward to the address")
	fmt.Println(" printchain - Prints the blocks in the chain")
	fmt.Println(" send -from FROM -to TO -amount AMOUNT -mine - Sends a specified amount of coins. The -mine flag is set to mine from this node")
